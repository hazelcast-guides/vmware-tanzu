:github-address: https://github.com/hazelcast-guides/vmware-tanzu
...
This guide will get you started to use Hazelcast IMDG Enterprise at VMware Tanzu Application Service(TAS).
...
[source,bash]
    $ export APP_ROUTE=`cf app hz-app | grep routes | awk '{ print $2 }'`
...
You can check other use cases for the tile like _WAN Replication_, _Rolling Upgrade_ at https://docs.pivotal.io/partners/hazelcast/using.html[official documantation].
